(function () {
  ...
  var LINKS = {
    ...
    rsvp: "https://wa.link/ujy3jg"
  };

  var BGM_BASE = 0.9;    // volume da música de fundo fora dos vídeos com voz
  var BGM_DUCK = 0.48;   // volume da música durante os vídeos com voz da menina
  var BGM_START_OFFSET = 75; // começa (e reinicia, ao repetir) em 1min15s
  ...
  function seekToStart() {
    try { bgm.currentTime = BGM_START_OFFSET; } catch (e) { /* ignora se ainda não tem metadados */ }
  }

  // toca em loop manualmente a partir do segundo 12 (em vez de reiniciar do zero)
  bgm.loop = false;
