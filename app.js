(function () {
  ...
  var BGM_BASE = 0.22;   // volume da música de fundo fora dos vídeos com voz
  var BGM_DUCK = 0.07;   // volume da música durante os vídeos com voz da menina
  ...
  function startBackgroundMusic() {
    ...
    var p = bgm.play();
    if (p && p.catch) {
      p.catch(function () { /* será tentado novamente no próximo toque */ started = false; });
    }
    fadeVolume(bgm, BGM_BASE, 900);
  }
